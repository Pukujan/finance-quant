...
def test_feature_eval_handler_is_checker_clean_and_deterministic(tmp_path):
    wo = WorkOrder(
    ...
    assert dict(a.metrics)["sma3"] == dict(b.metrics)["sma3"]
    assert dict(a.metrics)["sma3"] == 10.0
