...
Reset == /\ state \in {"PAPER", "TINY_LIVE", "REJECTED"} /\ state' = "IDLE" /\ current' = "" /\ UNCHANGED authorityRecords
Next == \E c \in Candidates: Seal(c) \/ Run \/ Score \/ Review \/ PaperApprove \/ Reject \/ TinyLiveApprove \/ Reset
